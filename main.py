...
# 蛇形排列处理
prelist = [4.65400,4.66100,4.6630]+[4.6700]*140+[4.6800]*140+[4.7200]*45+[4.7100]*44+[4.777,4.750,4.762,4.7633,4.499,4.493,4.521,4.511]
...
def sendemail(price_list,current_price):
    ...
    sorted_list.sort()
    percentnum = sorted_list[115]
    percent = 115 / len(sorted_list)*100
...
def getdata():
    ...
    path = Service(r"C:\Program Files\Python312\Scripts\edgedriver_win64\msedgedriver.exe")
